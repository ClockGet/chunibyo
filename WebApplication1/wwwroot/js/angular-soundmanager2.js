...
ngSoundManager.factory('angularPlayer', ['$rootScope', '$log',
    function ($rootScope, $log) {
        ...
        var currentTrack = null,
            ...
            lastAudio = null,
            showFrequency = null,
            _requestAnimationFrame = window.requestAnimationFrame || //Chromium  
        ...
        var res = {
            ...
            setShowFrequency: function (show) {
                showFrequency = show;
            },
            drawFrequency: function () {
                if (isPlaying && showFrequency && currentTrack) {
                    var audioElement = soundManager.sounds[currentTrack]._a;
                    ...
                    $rootScope.$broadcast('currentTrack:Frequency', dataArray);
                }
            },
            tick: function () {
                _requestAnimationFrame(res.tick);
                now = Date.now();
                if (now - then > 1000 / fps) {
                    then = now - ((now - then) % (1000 / fps));
                    res.drawFrequency();
                }
            },
...
ngSoundManager.directive('clearPlaylist', ['angularPlayer', '$log', '$rootScope',
    function (angularPlayer, $log, $rootScope) {
        return {
            restrict: "EA",
            link: function (scope, element, attrs) {
                element.bind('click', function (event) {
                    ...
                    $rootScope.$broadcast('track:id', null);
